...
namespace Up.Migrations
{
    ...
    [Migration("20220913220858_sync2")]
    partial class sync2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Up.Models.Entity.PayrollBookRow", b =>
                {
                    ...
                    b.Property<int?>("PayrollBookRowRequestId")
                        .HasColumnType("integer");

                    b.Property<double>("Pension")
                        .HasColumnType("double precision");

                    b.Property<double>("TotalDevengated")
                        .HasColumnType("double precision");

                    b.Property<double>("TransportAssistance")
                        .HasColumnType("double precision");
                    ...
                    b.HasIndex("PayrollBookRowRequestId");
            ...
            modelBuilder.Entity("Up.Models.Config.ClassificationDaysType", b =>
                {
                    b.HasOne("Up.Models.Types.TypePaymentDate", "TypePaymentDate")
                        .WithOne("ClassificationDaysType")
                        .HasForeignKey("Up.Models.Config.ClassificationDaysType", "TypePaymentDateId")
            ...
            modelBuilder.Entity("Up.Models.Entity.PayrollBookRow", b =>
                {
                    ...
                    b.HasOne("Up.Models.Entity.PayrollBookRowRequest", "PayrollBookRowRequest")
                        .WithMany()
                        .HasForeignKey("PayrollBookRowRequestId");

                    b.Navigation("Employee");

                    b.Navigation("PayrollBook");

                    b.Navigation("PayrollBookRowRequest");
                });
            ...
            modelBuilder.Entity("Up.Models.Types.TypePaymentDate", b =>
                {
                    b.Navigation("ClassificationDaysType");
                });
